...
[
    {
		...
		"def": 91,
		"hp": 128,
		"fastMoves": "Charm,Hidden Power",
		"chargeMoves": "Energy Ball,Seed Bomb",
		"legendary": false
	},{
		"name": "Lilligant",
		"id": 549,
		...
		"hp": 172,
		"fastMoves": "Charm,Hidden Power",
		"chargeMoves": "Petal Blizzard,Hyper Beam,Solar Beam",
		"legendary": false
	},{
...
[
	...
	["Cranidos","Rampardos"],
	["Shieldon","Bastiodon"],
	["Burmy","Wormadam Plant Cloak","Wormadam Sandy Cloak","Wormadam Trash Cloak","Mothim"],
	["Combee","Vespiquen"],
	["Buizel","Floatzel"],
	["Cherubi","Cherrim Overcast Form","Cherrim Sunshine Form"],
	["Shellos West Sea","Gastrodon West Sea"],
	["Shellos East Sea","Gastrodon East Sea"],
	["Drifloon","Drifblim"],
	["Buneary","Lopunny"],
	["Glameow","Purugly"],
	["Stunky","Skuntank"],
...
evolutionFamilies.forEach(
    function(family) {
        family.forEach(
            function(pokemon) {
                let name = pokemon.toLowerCase();
                if (!pokemonsMap[name]) {
                    // console.log("Couldn't find pokemon", name);
                }
                else {
                    pokemonsMap[name].evolutionFamily = family;
                }
            }
        );
    }
